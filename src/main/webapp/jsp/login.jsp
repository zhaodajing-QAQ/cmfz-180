       ...
       $(function () {
           ...
           * */
           $("#loginButtonId").click(function () {
               //正则表达式
               var pattern_userName = /^[a-zA-Z][a-zA-Z0-9_]{2,15}$/;
               var pattern_pwd = /^[a-zA-Z][a-zA-Z0-9_]{2,15}$/;
                //获取文本框中的值
               ...
               if (!pattern_userName.test(userName.trim())) {
                   document.getElementById("nameerror").innerText = "请输入账号";
                   return false;
               } else if (!pattern_pwd.test(userPwd.trim())) {
                   document.getElementById("pwderror").innerText = "请输入密码";
                   return false;
               } else{
                    ...
                    <div class="col-sm-6 col-sm-offset-3 form-box">
                        ...
                        <div class="form-bottom" style="width: 450px">
                            <form role="form" action="" method="post" class="login-form" id="loginForm">
                                ...
                                <div class="form-group">
                                    <img id="captchaImage" style="height: 41px" class="captchaImage"
